...
city: dieppe
title:
  en: "Scallops and Seafood"
  fr: "Coquilles et Fruits de Mer"
  es: "Vieiras y Marisco"
summary:
  en: "A morning at Dieppe's working fishing port, ending in a fresh seafood tasting by the harbour."
  fr: "Une matinée au port de pêche en activité de Dieppe, se terminant par une dégustation de fruits de mer frais face au port."
  es: "Una mañana en el puerto pesquero en activo de Dieppe, que termina con una degustación de marisco fresco junto al puerto."
duration:
  en: "3 hours"
  fr: "3 heures"
  es: "3 horas"
...
included:
  en:
    - "A visit to the working fishing port"
    - "A stop at the fish market to see the day's catch"
    - "A fresh seafood tasting overlooking the harbour, coquilles Saint-Jacques included"
  fr:
    - "Une visite du port de pêche en activité"
    - "Un passage à la criée pour voir la pêche du jour"
    - "Une dégustation de fruits de mer frais face au port, coquilles Saint-Jacques incluses"
  es:
    - "Una visita al puerto pesquero en activo"
    - "Una parada en la lonja para ver la pesca del día"
    - "Una degustación de marisco fresco frente al puerto, con vieiras incluidas"
description:
  en:
